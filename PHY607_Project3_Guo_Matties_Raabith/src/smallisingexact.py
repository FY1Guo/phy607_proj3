...
def plot_exact_vs_mcmc(
    exact_mags, exact_probs, mcmc_mags, beta, J, h, save_path="comparison.png"
):
    ...
    ax2.set_title(
        f"MCMC vs Exact\n{len(mcmc_mags)} samples", fontsize=13, fontweight="bold"
    )
